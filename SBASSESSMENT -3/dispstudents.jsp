...
ArrayList<Student> StudentList1=(ArrayList<Student>)session.getAttribute("studentList");
for(Student p:StudentList1)
{
	out.print("<tr>");
	out.print("<td>"+p.getSid()+"</td>");
	out.print("<td>"+p.getSname()+"</td>");
	out.print("<td> <label class='container'>Mark<input type='checkbox' name='status' value='"+p.getSid()+"'> <span class='checkmark'></span></label></td>");
	out.print("</tr>");
}
